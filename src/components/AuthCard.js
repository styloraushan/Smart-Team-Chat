                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        ...
                        <div className="grid grid-cols-2">
                            <button
                                className={`py-3 text-center font-semibold transition-colors ${mode === "login"
                            ...
                            <button
                                className={`py-3 text-center font-semibold transition-colors ${mode === "signup"
                                        ? "bg-blue-600 text-white"
                                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                                    }`}
                                ...
                                <div key={f.key}>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full rounded-xl border px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 ${errors[f.key] ? "border-red-400" : "border-gray-200"
                                                }`}
                                            value={form[f.key]}
